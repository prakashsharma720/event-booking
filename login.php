...
<body>
        ...
        <form action="register.php" method="POST">
            ...
            <!-- <div class="otp-container" style="display: none;">
                <div class="field otp-inputs">
                    ...
                    <div class="error-message-otp" style="color: red; display: none;"></div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        //           // Checking if all OTP fields are filled
        //           if (otpValue.length === 6) {
        //               otpErrorMessage.style.display = "none";
        //               console.log("OTP:", otpValue, "Mobile Number:", mobileNumber, "Order ID:",
        //                   orderId);
        //               alert("OTP Verified Successfully: " + otpValue);
        //               // You can replace the above `alert` with your verification logic
        //           } else {
        //               otpErrorMessage.style.display = "block";
        //               otpErrorMessage.textContent = "Please fill in all 6 digits of the OTP.";
        //           }
        //       });
        ...
        //           otpInput.classList.remove('error');
        //       } else {
        //           console.warn("Element with ID 'otp_box' not found.");
        //       }
        ...
        //               const otpInputContainer = document.querySelector(
        //                   '.otp-inputs'); // Reference to the OTP input container
        //               const verifyButton = document.querySelector(
        //                   '.verify_otp'); // Reference to the verify button
        ...
        document.querySelector('.verify_otp').addEventListener('click', function(event) {
            ...
            // Validate the OTP length and content
            if (!/^\d{6}$/.test(otpValue)) {
                otpErrorMessage.style.display = 'block';
                otpErrorMessage.innerText = 'Please enter a valid 6-digit OTP.';
                return;
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const otpInputs = document.querySelectorAll(".otp-box");
        const verifyButton = document.querySelector(".verify_otp");
        const errorMessage = document.querySelector(".error-message-otp");
