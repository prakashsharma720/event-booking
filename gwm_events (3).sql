...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2024 at 02:27 PM
...
INSERT INTO `bookings` (`id`, `transaction_date`, `user_id`, `event_code`, `booking_date`, `time`, `package_type`, `event_type`, `row`, `seat_no`, `total_amount`, `discount_value`, `discounty_type`, `net_total`, `no_of_tickets`, `advanced_pay`, `remaining_amount`, `payment_model`, `payment_reference_no`, `payment_screenshot`, `payment_status`, `area_of_interest`, `lead_source`, `booking_status`) VALUES
(2, '2024-07-29', 6, 'Y9qxF@XvOk7w', '2024-07-31', '9 am', 'Silver', 'Seminar', '2', 'NA', '15000.00', '1000.00', 'Early Birds', '14000.00', 1, '4000.00', '10000.00', 'UPI', 'WER$%#TTYHH', '', '', 'competitions', 'gwm_instagram', '');
...
(1, NULL, 1, '1,2,3,4,10,8,9,11,12,13,272,271,273,275,276,308,309,310,312,314,303,304,305,306,307,311,316,317'),
